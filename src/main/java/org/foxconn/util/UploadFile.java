...
public class UploadFile {
		...
		public static String deleteFromProduction(String url,
				int port,
				String username, 
				String password, 
				String path, 
		...
		public static void main(String[] args) throws UnsupportedEncodingException {
			...
			try {
//				 UploadFile.uploadFile("134.204.240.44", 21,"foxconn_tianjin","2496w29286456597198T", "/test",filename,inputStream );
				 String result = UploadFile.uploadFile("10.67.68.65", 21,"fcadmin","Foxcon99", "/test",filename,inputStream );
